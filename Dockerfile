...
ARG NEXT_PUBLIC_MEMBERS_SERVER_URL
ARG NEXT_PUBLIC_RESUMES_SERVER_URL
ARG NEXT_PUBLIC_PAYMENTS_SERVER_URL
ARG NEXT_PUBLIC_NOTIFICATIONS_SERVER_URL
ARG AUTH_SERVER_URL
...
ENV NEXT_PUBLIC_S3_URL=${NEXT_PUBLIC_S3_URL} \
    NEXT_PUBLIC_SERVICE_URL=${NEXT_PUBLIC_SERVICE_URL} \
    NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL} \
    NEXT_PUBLIC_AUTH_SERVER_URL=${NEXT_PUBLIC_AUTH_SERVER_URL} \
    NEXT_PUBLIC_MEMBERS_SERVER_URL=${NEXT_PUBLIC_MEMBERS_SERVER_URL} \
    NEXT_PUBLIC_RESUMES_SERVER_URL=${NEXT_PUBLIC_RESUMES_SERVER_URL} \
    NEXT_PUBLIC_PAYMENTS_SERVER_URL=${NEXT_PUBLIC_PAYMENTS_SERVER_URL} \
    NEXT_PUBLIC_NOTIFICATIONS_SERVER_URL=${NEXT_PUBLIC_NOTIFICATIONS_SERVER_URL} \
    ...
    NEXT_PUBLIC_SENTRY_KEY=${NEXT_PUBLIC_SENTRY_KEY}
